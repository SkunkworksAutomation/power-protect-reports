...
$Excel.cells.item($HeaderRow,2) = "createdAt"
$Excel.cells.item($HeaderRow,3) = "auditType"
$Excel.cells.item($HeaderRow,4) = "messageID"
$Excel.cells.item($HeaderRow,5) = "changeDescription"
$Excel.cells.item($HeaderRow,6) = "changedTime"
$Excel.cells.item($HeaderRow,7) = "changedBy"
$Excel.cells.item($HeaderRow,8) = "changedResourceType"
$Excel.cells.item($HeaderRow,9) = "changedResourceName"
...
for($i=0;$i -lt $Report.length; $i++) {
    ...
    $Excel.cells.item($RowOffSet,2) = $Report[$i].createdAt
    $Excel.cells.item($RowOffSet,3) = $Report[$i].auditType
    $Excel.cells.item($RowOffSet,4) = $Report[$i].messageID
    $Excel.cells.item($RowOffSet,5) = $Report[$i].changeDescription
    $Excel.cells.item($RowOffSet,6) = $Report[$i].changedTime
    $Excel.cells.item($RowOffSet,7) = $Report[$i].changedBy
    $Excel.cells.item($RowOffSet,8) = $Report[$i].changedResourceType
    $Excel.cells.item($RowOffSet,9) = $Report[$i].changedResourceName
